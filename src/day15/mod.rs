...
mod tests {
    ...
    #[test]
    fn example1() {
        let result = part1::solution(&utils::read_example_file("day15"));
        assert_eq!(result, "40");
    }

    #[test]
    fn part1() {
        let result = part1::solution(&utils::read_input_file("day15"));
        assert_eq!(result, "393");
    }

    #[test]
    fn part2_example() {
        let result = part2::solution(&utils::read_example_file("day15"));
        assert_eq!(result, "315");
    }

    #[test]
    fn part2() {
        let result = part2::solution(&utils::read_input_file("day15"));
        assert_eq!(result, "2823");
    }
}

fn read_cavemap(input: &str) -> CaveMap {
...
fn find_path_risk(map: CaveMap) -> String {
